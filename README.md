...
<center><img width=50% height=30% display=inline-block src="https://i.ibb.co/Rj7YpB4/creacked.png"><img width=50% height=30% display=inline-block src="https://i.ibb.co/1TywXCM/detect-ip.png"><br>
<img width=50% height=30% display=inline-block src="https://i.ibb.co/zZJQvY5/facebrute-trying.png"><img width=50% height=30% display=inline-block src="https://i.ibb.co/WH93dpT/response-txt.png"></center>
<h2> Requirements</h2>
